...
const WorkspaceOverview = () => {
  ...
  <div
    className={`flex h-10 w-10 items-center justify-center rounded-xl ${workspace.color}`}
  >
    ...
    <p className="mt-0.5 text-xs text-gray-500">
      {workspace.tasks} Tasks
            ...
            <div className="flex items-center justify-between pt-3 mt-3 border-t border-gray-100">
              ...
              <div className="rounded-md bg-orange-50 px-2 py-1 text-[11px] font-medium text-orange-600">
                Active
              </div>
            </div>
          </div>
